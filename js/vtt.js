...
const VTTManager = {
    ...
    monsterTypeIcons: {
        ...
        dragon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2 12c0-3 2-6 5-7l1-3 3 2 2-3 3 3 3-1 2 4c1 2 0 5-2 6l-4 4-4-2-5 3-4-2v-4z"/><path d="M7 4L5 1" stroke="currentColor" stroke-width="2.5"/><path d="M11 2L10 0" stroke="currentColor" stroke-width="2"/><path d="M16 3l2-2" stroke="currentColor" stroke-width="2"/><circle cx="7" cy="10" r="2.5" fill="white"/><circle cx="7.5" cy="10" r="1.2"/></svg>',

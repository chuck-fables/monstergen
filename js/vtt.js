...
const VTTManager = {
    ...
    monsterTypeIcons: {
        ...
        dragon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 18l2-4-1-4c0-3 2-5 5-6l2-2 2 2c3 1 5 3 5 6l-1 4 2 4h-4l-1-2h-4l-1 2H4z"/><path d="M8 4L6 1M11 3l1-2M16 4l2-3" stroke="currentColor" stroke-width="1.5" fill="none"/><circle cx="9" cy="10" r="1.5" fill="white"/><circle cx="9" cy="10" r=".7"/><circle cx="15" cy="10" r="1.5" fill="white"/><circle cx="15" cy="10" r=".7"/><ellipse cx="12" cy="14" rx="1.5" ry="1"/></svg>',

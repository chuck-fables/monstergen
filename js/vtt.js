...
const VTTManager = {
    ...
    monsterTypeIcons: {
        ...
        dragon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6 4l4 16M12 4l4 16M18 4l4 16" stroke="currentColor" stroke-width="3" stroke-linecap="round" fill="none"/></svg>',

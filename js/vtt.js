...
const VTTManager = {
    ...
    monsterTypeIcons: {
        ...
        dragon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M21 5l-3-2-4 3-2-1-4 4-5 1 2 4 4-1 3 4 5-2 1-5 3-1z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" fill="none"/><circle cx="11" cy="11" r="1.5" fill="currentColor"/></svg>',

...
const VTTManager = {
    ...
    monsterTypeIcons: {
        ...
        dragon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19.5 9.5c-1-1.5-2.5-2-4-2-1.5 0-2.5-1.5-2.5-3 0-1.5.5-2.5 1-3.5-2 0-3.5 1-4.5 2.5C8.5 5 7 7 7 9c0 1.5 1 2.5 2 3l-2 2c-1.5 1.5-2 3-2 4 0 2 2 3.5 4 3.5 1.5 0 3-1 4-2.5 1.5 1.5 3 2 5 2 1.5 0 2.5-1 2.5-2.5 0-1.5-1-2.5-2-3l1.5-2c.5-1 .5-2-1-4zM12 11a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/></svg>',
